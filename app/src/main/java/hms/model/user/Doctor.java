...
/**
 * Represents a doctor user within the system, extending the Staff class. Doctor have specific roles
 * and permissions that differentiate them from other user types.
 */
